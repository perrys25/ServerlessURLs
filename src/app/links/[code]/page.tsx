                ...
                <div className="mx-auto w-max">
                    <div
                        ...
                        <div className="px-6 py-4 space-y-4 md:px-8 w-full text-lg">
                            <h1 className="text-2xl font-bold w-max mx-auto">Link Details for <code className="bg-gray-300 rounded-md px-1">{code}</code></h1>
                            <span className="flex flex-row">
                                Shortened URL:&nbsp;<Link href={`${https ? "https" : "http"}://${host}/${code}`}><p className="text-blue-600 underline">{https ? "https" : "http"}://{host}/{code}</p></Link>
                            </span>
                            <span className="flex flex-row">
                                Original URL:&nbsp;<Link href={data.url}><p className="text-blue-600 underline">{data.url}</p></Link>
                            </span>
